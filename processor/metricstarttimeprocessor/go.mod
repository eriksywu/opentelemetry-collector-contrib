...
replace k8s.io/api v0.34.1 => k8s.io/api v0.32.3

replace k8s.io/apimachinery v0.34.1 => k8s.io/apimachinery v0.32.3

replace k8s.io/client-go v0.34.1 => k8s.io/client-go v0.32.3
